...
const EpisodeSelector: React.FC<EpisodeSelectorProps> = ({
  ...
  // 主 tab 状态：'episodes' | 'sources' | 'danmaku'
  // 当只有一集时默认展示“换源”，并隐藏“选集”
  ...
  return (
    <div className='md:ml-2 px-4 py-0 h-full rounded-xl border border-gray-200/60 bg-white/70 shadow-sm backdrop-blur-xl dark:border-zinc-700/70 dark:bg-black/80 flex flex-col overflow-hidden'>
      {/* 主 Tab 切换 */}
                        ...
                        <div className='flex-1 min-w-0 flex flex-col justify-between h-20'>
                          ...
                          <div className='flex items-start justify-between gap-3 h-6'>
                            ...
                            {(() => {
                              ...
                              if (videoInfo && videoInfo.quality !== 'Unknown') {
                                if (videoInfo.hasError) {
                                  ...
                                  // 分辨率颜色：2K/4K 紫色，1080p/720p 蓝色，其它黄色
