...
const DoubanSelector: React.FC<DoubanSelectorProps> = ({
  ...
  const moviePrimaryOptions: SelectorOption[] = [
    { label: 'Popular', value: '热门' },
    { label: 'Latest', value: '最新' },
    { label: 'Top Rated', value: '豆瓣高分' },
    { label: 'Hidden Gems', value: '冷门佳片' },
  ];

  // 电影的二级选择器选项
  const movieSecondaryOptions: SelectorOption[] = [
    { label: 'All', value: '全部' },
    { label: 'Chinese', value: '华语' },
    { label: 'Western', value: '欧美' },
    { label: 'Korean', value: '韩国' },
    { label: 'Japanese', value: '日本' },
  ];

  // 电视剧选择器选项
  const tvOptions: SelectorOption[] = [
    { label: 'All', value: 'tv' },
    { label: 'Mainland China', value: 'tv_domestic' },
    { label: 'Western', value: 'tv_american' },
    { label: 'Japanese', value: 'tv_japanese' },
    { label: 'Korean', value: 'tv_korean' },
    { label: 'Anime', value: 'tv_animation' },
    { label: 'Documentary', value: 'tv_documentary' },
  ];

  // 综艺选择器选项
  const showOptions: SelectorOption[] = [
    { label: 'All', value: 'show' },
    { label: 'Domestic', value: 'show_domestic' },
    { label: 'International', value: 'show_foreign' },
  ];
        ...
        {options.map((option, index) => {
          ...
          return (
            <button
              ...
              className={`relative z-10 px-3 py-1 sm:px-4 sm:py-2 text-sm font-medium rounded-full transition-all duration-200 whitespace-nowrap ${
                isActive
